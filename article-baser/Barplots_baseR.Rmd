...
```
<p style="font-weight: bold; text-indent: 30px;">Figure 1: Clustered bar graph created using barplot().
</p> 
...
```
<p style="font-weight: bold; text-indent: 30px;">Figure 2: Clustered bar graph with added product colors.</p> 
...
```
<p style="font-weight: bold; text-indent: 30px;">Figure 3: Clustered bar graph with customized legend.
</p> 
...
```
<p style="font-weight: bold; text-indent: 30px;">Figure 4: Clustered bar graph with adjusted margins.
</p> 
...
```
<p style="font-weight: bold; text-indent: 30px;">Figure 5: Clustered bar graph with various modifications.
</p> 

...
fig.show()
```
<p style="font-weight: bold; text-indent: 30px;">Figure 1. Clustered bar graph created using plotly.express.
</p> 
...
fig_go.show()
```
<p style="font-weight: bold; text-indent: 30px;">Figure 2: Clustered bar graph created using plotly.graph_objects. </p> 
...
```
<p style="font-weight: bold; text-indent: 30px;">Figure 3: Clustered bar graph created using pandas’ plot() method.</p> 
...
plt.show()
```
<p style="font-weight: bold; text-indent: 30px;">Figure 4: Clustered bar graph created using matplotlib’s bar() method.</p> 
...
plt.show()
```
<p style="font-weight: bold; text-indent: 30px;">Figure 5: Clustered bar graph created using Seaborn’s barplot() method.</p> 
